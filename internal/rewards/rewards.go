...
func (r *Rewards) calculateBlockReward(total_stake, current_total_dly_supply *big.Int) (block_reward *big.Int, yield *big.Int) {
	yield = r.calculateCurrentYield(current_total_dly_supply)
